 ...
 */
public class BNF {
    public HashMap<Token, Tree<Token>> rules;
    public BnfTokenizer rulesTokenizer;
    public Stack<Tree<Token>> stack;
    public Token currentKey;
     ...
     */
    public Tree<Token> getStackItem(int n) {
...
//        System.out.println(string.toString());
     ...
     */
    public void writeHelper(Tree<Token> tree) {
